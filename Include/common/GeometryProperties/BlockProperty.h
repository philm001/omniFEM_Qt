...
private:
	...
	void serialize(Archive &ar, const unsigned int version)
	{
		...
		ar & _meshSizeIsAuto;
		ar & _numberOfTurns;
//		std::string magnet = _magnetization.ToStdString(); // TODO: Fix Me
	//	ar & magnet; // TODO: Fix Me
///		_magnetization = wxString(magnet); // TODO Fix Me
		ar & _groupNumber;
...
public:
    ...
    */ 
    void setMagnetization(QString value)
    {
